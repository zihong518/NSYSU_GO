// var re=document.getElementById('register_all');
// test.innerHTML +=
// `
...
//                 註冊
//             </div>
//             <input type="text" class="form-control py-2 my-3 inner_shadow" placeholder="信箱">
//             <input type="password" class="form-control py-2 my-3 inner_shadow" placeholder="密碼">
//             <input type="password" class="form-control py-2 my-3 inner_shadow" placeholder="確認密碼">
//             <input type="text" class="form-control py-2 mt-3 inner_shadow" placeholder="學號">
//             <div class="d-flex">
//                 <select class="form-select my-3 w-50 d-inline me-2 inner_shadow" aria-label="Default select example">
